...
class DistanceGANModel(CycleGANModel):
    ...
    def set_expectation_and_std(self):
        ...
        self.expectation_A = self.get_expectation(num_vars_A, A_vars).astype(float) # rui
        self.expectation_B = self.get_expectation(num_vars_B, B_vars).astype(float) # rui
        self.std_A = self.get_std(num_vars_A, A_vars, self.expectation_A).astype(float) # rui
        self.std_B = self.get_std(num_vars_B, B_vars, self.expectation_B).astype(float) # rui
